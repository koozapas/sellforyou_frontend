            ...
            >
                <Col span={18} style={{
                    ...
                    <Row style={{ marginTop: "22px" }}>
                        ...
                        <Col span={8}>
                            사업자등록번호: 644-88-01715
                        </Col>

                        <Col span={8}>
                            통신판매신고번호: 2020-울산중구-0208
                        </Col>
                        ...
                        <Col span={24}>
                            주소: 울산광역시 중구 종가로 406-21, C동 533호 534호
                        </Col>
                    </Row>

                    <Row style={{ marginTop: "10px" }}>
                        <Col style={{ color: "#C7C7C7" }}>
                        Copyright (c) KOOZAPAS All Rights Reserved
                        </Col>
                    </Row>
                </Col>
                ...
                <Col span={6}>
                    ...
                    <Button
                        ...
                        onClick={() => {
                            if (whoAmI?.whoami.includes("Admin"))
                    ...
                    <AdminLoginModal
                        visible={adminLoginModal}
                        closeAdminLoginModal={() => setAdminLoginModal(false)}
                    />
                </Col>
            </Row>
        </Footer>
