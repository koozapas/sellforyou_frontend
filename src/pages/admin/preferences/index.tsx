...
const PreferencesPage = () => {
  ...
  const [updateCnyRate] = useMutation<{ updateCnyRateByAdmin: number }, MutationUpdateCnyRateByAdminArgs>(MUTATIONS.UPDATE_CNY_RATE)
  ...
  return (
    <Card title="고시환율 및 카테고리">
      <Row align="middle" className='mb-4'>
        ...
        <Col>
          <Button
            onClick={() => { updateCategoryMutation() }}
          >
            업데이트
          </Button>
        </Col>
      ...
      <Row align="middle">
        ...
        <Col>
          <InputNumber
            value={cnyRate}
            onChange={(e) => { setCnyRate(e as number) }}
          />
          <Button
