...
import { Descriptions, Select, Form } from "antd";
const { Option } = Select;
...
const SelectSiilWrapPage = ({ setSillData, sillData }: IProps) => {
  ...
  // useEffect(() => {
  //   if (selectSillNum.length !== 0)
  //     setSillDataLazyQuery({ variables: { code: selectSillNum } })
  // }, [selectSillNum])
      ...
      >
        <Descriptions bordered>
          <Descriptions.Item
            ...
            label={
              <div
                style={{ color: "#000000", fontSize: "14px", width: "150px" }}
              >
                분류선택
              </div>
            }
          >
            <Form.Item name="siilCode">
              <Select
                placeholder="고시정보 선택"
...
export default SelectSiilWrapPage;
